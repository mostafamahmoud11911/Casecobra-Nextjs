...
export default function ThankYou() {
    ...
    const { configuration, amount, billingAddress, shippingAddress } = data;
        ...
        <div className='bg-white'>
            <div className='mx-auto max-w-3xl px-4 py-14 sm:px-6 sm:py-24 lg:px-8'>
                <div className='max-w-xl'>
                    ...
                    <h1 className='text-4xl mt-2 font-bold tracking-tight sm:text-base'>You case is on the way</h1>
                    <p className='text-zinc-500 mt-2 text-base'>We&apos;ve received your order and are now processing it</p>
                ...
                <div className='mt-10 border-t border-zinc-200'>
                    <div className='mt-10 flex flex-auto flex-col'>
                        <h4 className='font-semibold text-zinc-900'>you made a greet choice!</h4>
                        <p className='mt-2 text-sm text-zinc-600'>We at CaseCobra believe that a phone case doesn&apos;t only need to
